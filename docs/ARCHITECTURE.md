...
aeng bitacola -p <dir> -x <book.xlsx>  # fill an incident event-log workbook from the parsed case
...
src/artifact_engine/
  ...
  core/
    ...
    bitacola.py          incident event-log rows derived from the parsed case
    xlsx_inplace.py      patch cells into an .xlsx without losing its validations
